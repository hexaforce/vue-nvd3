    ...
    <nav class="uk-navbar">
      <div class="uk-container uk-container-center">
        ...
        <ul class="uk-navbar-nav">
          <li>
            <a href="https://github.com/DotNetAge/vue-nvd3" target="_blank">Github</a>
          </li>
          <li>
        ...
        <div class="uk-navbar-flip">
          <ul class="uk-navbar-nav">
            <li>
              <a href="https://github.com/DotNetAge/vue-nvd3/issues" target="_blank">Issues</a>
            </li>
            <li>
              <a href="http://www.cnblogs.com/ray-liang" target="_blank">My Blog</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="uk-width-medium-1-1">
          <div class="uk-grid">
            <div class="uk-width-medium-1-4">
              <ul class="uk-tab uk-tab-left uk-width-medium-1-1" data-uk-tab>
                <li class="uk-active">
                  <router-link :to="{name:'BarChart'}">Bar chart</router-link>
                </li>
                <li>
                  <router-link :to="{name:'BubbleChart'}">Bubble chart</router-link>
                </li>
                <li>
                  <router-link :to="{name:'HBarChart'}">Multi-bar horizontal chart</router-link>
                </li>
                <li>
                  <router-link :to="{name:'LineChart'}">Line chart</router-link>
                </li>
                <li>
                  <router-link :to="{name:'LineBarChart'}">Line-Bar combo chart</router-link>
                </li>
                <li>
